...
<fieldset>
    ...
    <table>
    	<tr>
    		<td>User Name </td>
    		<td>:</td>
    		<td><input type="text" name="uname" id="uname" placeholder="User Name" onkeyup="checkUserName()" onblur="checkUserName()" value="<?php if(isset($_COOKIE["uname"])){ echo $_COOKIE["uname"];} ?>">
    	...
    	<tr>
    		<td>Password </td>
    		<td>:</td>
    		<td><input type="password" name="password" id="password" placeholder="Password" onkeyup="checkPassword()" onblur="checkPassword()" value="<?php if(isset($_COOKIE["password"])){ echo $_COOKIE["password"];} ?>">
